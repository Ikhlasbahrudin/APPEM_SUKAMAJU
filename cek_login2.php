<?php
// Pastikan untuk memulai sesi sebelum mengakses variabel $_SESSION
session_start();
...
<body>
    <div class="container">
        <div class="alert alert-danger alert-dismissible fade show alert-box" role="alert">
            <div class="warning-text">Warning:</div>
            <div class="message-text">Username dan Password Salah</div>
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    setTimeout(function() {
        window.location.href = 'index2.php'; // Redirect ke index.php setelah 3 detik
    }, 3000);
    </script>
</body>
