    ...
    if(isset($_POST["submit"])) {
        ...
        if(in_array($file_type, $allowed_extensions)) {
            ...
            if(move_uploaded_file($file_tmp, $upload_path.$file_name)) {
                ...
                $query = "INSERT INTO berita (judul, penulis, kategori, konten, tanggal_publikasi, thumbnail) 
                          VALUES ('$title', '$author', '$category', '$content', '$current_date', '$file_name')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add New berita</h1>
                    <!-- Current Date -->
