...
<body id="page-top">
  ...
  <div class="container-fluid">
    ...
    <h6 class="m-0 font-weight-bold text-secondary">Jalan Cianjur Kode Pos:12345</h6>
        ...
        <div style="text-align: center;">
    <h6 class="m-0 font-weight-bold text-secondary">Laporan Data Masyarakat</h6>
</div>
          <br><br>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                if (!$sql || mysqli_num_rows($sql) === 0) {
                    // Jika query gagal atau tidak ada data, tampilkan pesan error
                    echo "<tr><td colspan='5'>Data tidak tersedia.</td></tr>";
                } else {
                    // Jika query berhasil dan ada data, tampilkan data
