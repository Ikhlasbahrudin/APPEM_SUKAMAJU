...
if(isset($_POST['update'])) {
    ...
    if(isset($_FILES['thumbnail']['name']) && !empty($_FILES['thumbnail']['name'])) {
        ...
        $oldThumbnailPath = "../assets/img/post/" . $post['thumbnail'];
        ...
        $thumbnail_path = "../assets/img/post/" . $thumbnail;
    ...
    $update_query = "UPDATE posts SET title='$title', author='$author', category='$category', content='$content', thumbnail='$thumbnail' WHERE id='$postId'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category" name="category" required>
                                ...
                                <option value="Sosial" <?php if($post['category'] == 'Sosial') echo 'selected'; ?>>
                                    Sosial</option>
                                <option value="Pembangunan"
                                    <?php if($post['category'] == 'Pembangunan') echo 'selected'; ?>>Pembangunan
                                </option>
                                <option value="Kesehatan"
                                    <?php if($post['category'] == 'Kesehatan') echo 'selected'; ?>>Kesehatan</option>
                            </select>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <img src="../assets/img/post/<?php echo $post['thumbnail']; ?>" alt="Thumbnail"
